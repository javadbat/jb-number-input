...
export function renderButtonsHTML(): string {
  ...
  <div class="number-control-buttons">
    <div class="increase-number-button number-control-button" role="button" aria-label="${dictionary.get(i18n, "increaseValue")}">
    ...
    <div class="decrease-number-button number-control-button" role="button" aria-label="${dictionary.get(i18n, "decreaseValue")}">
